...
function CloseOnClickOutside_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { CloseOnClickOutside_typeof = function _typeof(obj) { return typeof obj; }; } else { CloseOnClickOutside_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return CloseOnClickOutside_typeof(obj); }
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) CloseOnClickOutside_setPrototypeOf(subClass, superClass); }

function CloseOnClickOutside_setPrototypeOf(o, p) { CloseOnClickOutside_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return CloseOnClickOutside_setPrototypeOf(o, p); }

function _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }

function _possibleConstructorReturn(self, call) { if (call && (CloseOnClickOutside_typeof(call) === "object" || typeof call === "function")) { return call; } return CloseOnClickOutside_assertThisInitialized(self); }

function CloseOnClickOutside_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var CloseOnClickOutside = /*#__PURE__*/function (_Extension) {
  ...
  function CloseOnClickOutside() {
    ...
    _set((_thisSuper = CloseOnClickOutside_assertThisInitialized(_this), _getPrototypeOf(CloseOnClickOutside.prototype)), "name", "close on click outside", _thisSuper, true);
...
var Icon = /*#__PURE__*/function () {
  ...
  Icon_createClass(Icon, [{
    ...
    value: function render() {
      ...
      this.element.className = clsx_m(this.data.icon[0] || buttonizer_defaults.frontend.data.icon.icon, this.stylesheet.classes.icon);
...
var WebsiteUrl = /*#__PURE__*/function (_Action) {
  ...
  WebsiteUrl_createClass(WebsiteUrl, [{
    ...
    value: function addAttr() {
      ...
      return {
        attr: "href",
        val: dlv_umd_default()(this.data, "action", "#")
      };
    }
  }]);
...
var Button = /*#__PURE__*/function () {
  ...
  Button_createClass(Button, [{
    ...
    value: function setAction(action) {
      ...
      this.element.setAttribute(action.addAttr().attr, action.addAttr().val);
...
function TextIcon_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
function MenuStyles_Default_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var Default_Default = /*#__PURE__*/function (_MenuStyle) {
...
var Rectangle = /*#__PURE__*/function (_MenuStyle) {
  ...
  function Rectangle() {
    ...
    }, false); // Reset label width when preview changes
    ...
    if (buttonizerInPreview_inPreview()) {
      window.Buttonizer.addHook("buttonizer_live_update", function (_ref2) {
        ...
        if (groupId === _this.id && (key === "label" || key === "menu_style")) {
          _this.setSameWidthLabels(groups[_this.id].buttons);
        }
      });
    }
...
var EditButton = /*#__PURE__*/function (_Generator) {
  ...
  EditButton_createClass(EditButton, [{
    ...
    value: function editButton(button, group_id, is_group) {
      ...
      editButtonAction.className = clsx_m("buttonizer-button-admin-action buttonizer-edit-action", this.horizontal, this.vertical);
...
function createButton() {
  ...
  if (parsedData.icon !== "unset" && !parsedData.icon_is_image) result.icon = new Icon({
    stylesheet: stylesheet,
    data: {
  ...
  });else if (parsedData.icon_image !== "unset" && parsedData.icon_is_image) {
    /* webpack-strip-block:removed */
    // Fallback when icon_is_image is used but doesn't have premium.
  ...
  if (parsedData.label || is_menu_button === true) result.label = new Label({
    stylesheet: stylesheet,
    data: ButtonizerUtils_objectSpread(ButtonizerUtils_objectSpread({}, parsedData), pos)
  });
...
function parseData(data) {
  ...
  ["background_color", "background_image", "label_color", "label_background_color", "icon_color", "icon_image_size", "icon_image_border_radius", "icon_image", "icon_size", "icon", "border_radius", "label_font_size", "label_border_radius", "label_margin", "label_padding", "background_is_image"].forEach(function (key) {
    ...
    var result = formats.normal_hover.parse(returnData[key]);
  ...
  if (typeof returnData.id !== "string") returnData.id = GenerateUniqueId();
  return returnData;
}
...
var Buttonizer = /*#__PURE__*/function () {
  function Buttonizer() {
  ...
  Buttonizer_createClass(Buttonizer, [{
    ...
    value: function init(data) {
      ...
      if (buttonizerInPreview_inPreview()) {
        ...
        data.result.map(function (group) {
          _this2.data[group.data.id] = group;
        });
      }
      /* webpack-strip-block:removed */
      // No buttons
    ...
    value: function updateLivePreviewData(_ref2) {
      var _this5 = this;
      ...
      if (model === "group") {
        ...
        groupId = Object.keys(this.data).find(function (groupObjKey) {
          return _this5.data[groupObjKey].buttons.find(function (buttonObj, buttonObjKey) {
            if (buttonObj.id === id) {
